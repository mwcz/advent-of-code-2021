...
If you like to tweak solutions after finding the answer, it can be helpful to write a simple test.  Tests are included in `templates/d.rs` which is used to stamp down `src/d1.rs`, etc.  The tests begin commented out, and can be uncommented when you're ready.
...
## Cons
 ...
 - No built-in benchmarking, but that could be added
